...
export class NotificationItemComponent {
  ...
  private static colors: Record<string, string> = {
    NEW_MEMBER:'#FF6B35',     PRICE_DROP:'#F4A902',
    GROUP_SUCCESS:'#F4A902',  GROUP_FAILED:'#FF4D6A',
    PAYMENT_DUE:'#0DA487',    DELIVERY_UPDATE:'#0DA487', SYSTEM:'#7B2FBE',
  };
  private static bgs: Record<string, string> = {
    NEW_MEMBER:'rgba(255,107,53,.12)',   PRICE_DROP:'rgba(244,169,2,.12)',
    GROUP_SUCCESS:'rgba(244,169,2,.12)', GROUP_FAILED:'rgba(255,77,106,.12)',
    PAYMENT_DUE:'rgba(13,164,135,.1)',   DELIVERY_UPDATE:'rgba(13,164,135,.1)',
    SYSTEM:'rgba(123,47,190,.12)',
  };
