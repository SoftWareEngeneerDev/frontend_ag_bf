...
export class MockDataService {
  ...
  readonly categories: Category[] = [
    { id:'cat-1', name:'Électronique',    icon:'📱', slug:'electronique',   productCount:45 },
    { id:'cat-2', name:'Alimentaire',     icon:'🌾', slug:'alimentaire',    productCount:32 },
    { id:'cat-3', name:'Textile & Mode',  icon:'👗', slug:'textile',        productCount:28 },
    { id:'cat-4', name:'Maison & Jardin', icon:'🏠', slug:'maison',         productCount:21 },
    { id:'cat-5', name:'Santé & Beauté',  icon:'💊', slug:'sante',          productCount:15 },
    { id:'cat-6', name:'Agriculture',     icon:'🌱', slug:'agriculture',    productCount:12 },
  ];
    ...
    return [
      {
        ...
        images:[], soloPrice:285000, minGroupPrice:185250,
      ...
      },
      {
        ...
        images:[], soloPrice:320000, minGroupPrice:214400,
        category:this.categories[0], supplier:this.suppliers[0],
      ...
      },
      {
        ...
        images:[], soloPrice:185000, minGroupPrice:129500,
      ...
      },
      {
        ...
        images:[], soloPrice:22500, minGroupPrice:16425,
      ...
      },
      {
        ...
        images:[], soloPrice:35000, minGroupPrice:24850,
      ...
      },
      {
        ...
        images:[], soloPrice:245000, minGroupPrice:169050,
        category:this.categories[3], supplier:this.suppliers[1],
      ...
      },
      {
        ...
        images:[], soloPrice:395000, minGroupPrice:276500,
        category:this.categories[0], supplier:this.suppliers[0],
      ...
      },
      {
        ...
        images:[], soloPrice:95000, minGroupPrice:66500,
        category:this.categories[3], supplier:this.suppliers[1],
